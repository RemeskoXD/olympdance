      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-gray-900">9.6 <span className="text-sm text-gray-400 font-normal">/ 10</span></p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-gray-900">9.5 <span className="text-sm text-gray-400 font-normal">/ 10</span></p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-3xl font-bold text-gray-900">9.3 <span className="text-sm text-gray-400 font-normal">/ 10</span></p>
          </div>
        </div>
      </div>
