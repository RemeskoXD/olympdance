  ...
  return (
    <section className="relative pt-12 pb-12 lg:pt-20 lg:pb-12 overflow-hidden bg-gradient-to-br from-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-6 font-display" dangerouslySetInnerHTML={{ __html: title.replace(/z pohybu a tance/gi, '<br/><span class="text-brand-blue">z pohybu a tance</span>') }}>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link to="/tanecnikrouzky" className="px-8 py-4 bg-brand-blue text-white rounded-xl font-bold text-lg hover:bg-blue-800 transition-all shadow-lg hover:shadow-brand-blue/30 flex items-center justify-center transform hover:-translate-y-1">
            Najít kroužek
            <ArrowRight className="ml-2 w-5 h-5" />
          </Link>
          <Link to="/letnicampy" className="px-8 py-4 bg-white text-brand-blue border-2 border-brand-blue rounded-xl font-bold text-lg hover:bg-blue-50 transition-all flex items-center justify-center transform hover:-translate-y-1">
            Letní tábory
          </Link>
        </div>
